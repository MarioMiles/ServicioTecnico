 ...
 */
final class Version20220314103235 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE incidencia (id INT AUTO_INCREMENT NOT NULL, id_usuario_id INT DEFAULT NULL, cliente_id INT DEFAULT NULL, titulo VARCHAR(200) NOT NULL, fecha_creacion DATETIME NOT NULL, estado VARCHAR(200) NOT NULL, INDEX IDX_C7C6728C7EB2C349 (id_usuario_id), INDEX IDX_C7C6728CDE734E51 (cliente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
